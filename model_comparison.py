...
def plot_past_emissions():
    ...
    np.save('jsbach_data_past',jsbach_data)
    np.save('clm_data_past',clm_data)
    np.save('blaze_data_past',blaze_data)
    np.save('orchidee_data_past',orchidee_data)
    np.save('ctem_data_past',ctem_data)
